...
(function ($, anim) {
	...
	var Dropdown = (function (_Component2) {
		...
		function Dropdown(el, options) {
			...
			_this8._handleDocumentClickBound = _this8._handleDocumentClick.bind(
				_this8
			);
			_this8._handleDocumentTouchmoveBound = _this8._handleDocumentTouchmove.bind(
				_this8
			);
			_this8._handleDropdownClickBound = _this8._handleDropdownClick.bind(
				_this8
			);
			_this8._handleDropdownKeydownBound = _this8._handleDropdownKeydown.bind(
				_this8
			);
			_this8._handleTriggerKeydownBound = _this8._handleTriggerKeydown.bind(
				_this8
			);
						...
						var enterAnimOptions = {
							...
							complete: function () {
								if (typeof _this13.options.onOpenEnd === 'function') {
									_this13.options.onOpenEnd.call(
										_this13,
										_this13.el,
...
(function ($) {
	...
	var Parallax = (function (_Component5) {
		...
		function Parallax(el, options) {
			...
			_this20._enabled =
				window.innerWidth > _this20.options.responsiveThreshold;
			...
			[
				...
				},
				{
					...
					value: function _createIndicator() {
						...
						setTimeout(function () {
							_this23._indicator.style.left =
								_this23._calcLeftPos(_this23.$activeTabLink) + 'px';
							_this23._indicator.style.right =
								_this23._calcRightPos(_this23.$activeTabLink) + 'px';
						}, 0);
					},
...
(function ($, anim) {
	...
	var Sidenav = (function (_Component8) {
		...
		function Sidenav(el, options) {
			...
			var _this30 = _possibleConstructorReturn(
				this,
...
(function ($, anim) {
	...
	var ScrollSpy = (function (_Component9) {
		...
		function ScrollSpy(el, options) {
			...
			var _this34 = _possibleConstructorReturn(
				this,
...
(function ($) {
	...
	var Autocomplete = (function (_Component10) {
		...
		function Autocomplete(el, options) {
			...
			var _this36 = _possibleConstructorReturn(
				this,
					...
					value: function _renderDropdown(data, val) {
						...
						if (this.options.sortFunction) {
							var sortFunctionBound = function (a, b) {
								return _this38.options.sortFunction(
									a.key.toLowerCase(),
									b.key.toLowerCase(),
									val.toLowerCase()
								);
...
(function ($, anim) {
	...
	var Slider = (function (_Component11) {
		...
		function Slider(el, options) {
			...
			var _this39 = _possibleConstructorReturn(
				this,
			...
			_this39.activeIndex = _this39.$slides
					...
					value: function _setupEventHandlers() {
						...
						if (this.options.indicators) {
							this.$indicators.each(function (el) {
								el.addEventListener(
									'click',
									_this40._handleIndicatorClickBound
								);
							});
						}
					},
...
(function ($) {
	...
	var Chips = (function (_Component12) {
		...
		function Chips(el, options) {
			...
			_this44.$chips = $();
			_this44._setupInput();
			_this44.hasAutocomplete =
				Object.keys(_this44.options.autocompleteOptions).length > 0;
...
(function ($, anim) {
	...
	var FloatingActionButton = (function (_Component14) {
		...
		function FloatingActionButton(el, options) {
			...
			_this47.$floatingBtnsReverse = _this47.$el
					...
					value: function _animateInToolbar() {
						...
						setTimeout(function () {
							...
							setTimeout(function () {
								...
								// Scroll to close.
								_this50._handleDocumentClickBound = _this50._handleDocumentClick.bind(
									_this50
								);
								window.addEventListener(
									'scroll',
									_this50._handleCloseBound,
									true
								);
								document.body.addEventListener(
									'click',
									_this50._handleDocumentClickBound,
									true
								);
							}, 100);
						}, 0);
...
(function ($) {
	...
	var Carousel = (function (_Component18) {
		...
		function Carousel(el, options) {
			...
			_this61.showIndicators =
				_this61.options.indicators && _this61.hasMultipleSlides;
			...
			_this61.images = [];
			_this61.itemWidth = _this61.$el
				.find('.carousel-item')
				.first()
				.innerWidth();
			_this61.itemHeight = _this61.$el
				.find('.carousel-item')
				.first()
				.innerHeight();
			...
			_this61.options.numVisible = Math.min(
				_this61.count,
				_this61.options.numVisible
			);
					...
					value: function _setupEventHandlers() {
						...
						if (this.showIndicators && this.$indicators) {
							...
							this.$indicators.find('.indicator-item').each(function (el, i) {
								el.addEventListener(
									'click',
									_this62._handleIndicatorClickBound
								);
							});
						}
...
(function ($) {
	...
	var TapTarget = (function (_Component19) {
		...
		function TapTarget(el, options) {
			...
			var _this66 = _possibleConstructorReturn(
				this,
					...
					value: function _setupDropdown() {
							...
							this.$selectOptions.each(function (el) {
								if ($(el).is('option')) {
									...
									if (_this70.isMultiple) {
										optionEl = _this70._appendOptionWithIcon(
											_this70.$el,
											el,
											'multiple'
										);
									...
									$(_this70.dropdownOptions).append(
										$(
									...
									selectOptions.each(function (el) {
										var optionEl = _this70._appendOptionWithIcon(
											_this70.$el,
											el,
											'optgroup-option'
										);
						...
						if (!this.el.disabled) {
							...
							dropdownOptions.onOpenEnd = function (el) {
								var selectedOption = $(_this70.dropdownOptions)
									.find('.selected')
									.first();
								if (_this70.dropdown.isScrollable && selectedOption.length) {
									var scrollOffset =
										selectedOption[0].getBoundingClientRect().top -
										_this70.dropdownOptions.getBoundingClientRect().top; // scroll to selected option
...
(function ($, anim) {
	...
	var Range = (function (_Component21) {
		...
		function Range(el, options) {
			...
			var _this71 = _possibleConstructorReturn(
				this,
