...
!(function (t) {
	...
	function e(t) {
		if (!O) {
			var e = (O = x.implementation.createHTMLDocument(null)).createElement(
				'base'
			);
	...
	function i(t) {
		'loading' !== x.readyState
			? t()
			: x.addEventListener('DOMContentLoaded', t);
	}
	function n(n, s) {
		if (!n) return this;
		...
		var o,
			...
			r = 0;
		if (A(n))
			a = R.test(n) ? x.getElementById(n.slice(1)) : P.test(n) ? e(n) : t(n, s);
							...
							},
							{
								...
								value: function (t) {
									this.el.contains(t.target) ||
										this._nthModalOpened !== s._modalsOpen ||
										this.el.focus();
								},
							},
							{
							...
							},
							{
								...
								value: function (t) {
									...
									13 !== t.keyCode &&
										38 !== t.keyCode &&
										40 !== t.keyCode &&
										(this.oldVal !== e && M.tabPressed && this.open(),
										(this.oldVal = e));
								},
							},
							{
								...
								value: function (e) {
									...
									i === M.keys.ENTER && this.activeIndex >= 0
										? (s = t(this.container)
												.children('li')
